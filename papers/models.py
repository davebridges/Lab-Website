...
class Publication(models.Model):
    ...
    pmid = models.IntegerField(blank=True, null=True, help_text='PubMed Idenfifier')
    pmcid = models.IntegerField(blank=True, null=True, help_text='PubMed Central Idenfifier')    
